...
export default class UserMiddleware {
  ...
  public checkClasse = async (req: Request, res: Response, next: NextFunction) => {
  ...
  public checkLevel = async (req: Request, res: Response, next: NextFunction) => {
  ...
  public checkPassword = async (req: Request, res: Response, next: NextFunction) => {
